    ...
    >
      ...
      >
        ...
        {isText && !selected && card.sourceName && (
          <SourceLine name={card.sourceName} url={card.sourceUrl} />
        )}
...
// The resting "from …" stamp — a bit's source travels with it (P8). Read-only; the
// ↗ opens the source in a new tab and swallows the pointer so the card doesn't
// select or drag under it. One definition: the text half and the media half of this
// card rendered this markup twice, byte for byte.
