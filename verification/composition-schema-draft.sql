-- ============================================================================
-- THE COMPOSITION SPLIT — draft DDL (end-state). STORAGE SESSION 2026-09-04.
-- ⚠ A DRAFT: lives in verification/, NEVER in supabase/migrations/ (the
--   exported-tables set-equality test reads that directory; this ships at
--   enactment with EXPORTED_TABLES += composition, composition_file in the
--   same change — I-G1 lockstep, spec §12.5).
-- Decisions + citations: composition-storage-decisions.md (S1–S8, Q).
-- Charter: every element cites its ruling; anything uncited is a defect.
-- ============================================================================
