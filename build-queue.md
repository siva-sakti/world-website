...
1. **THE PLATFORM (this queue, ACTIVE):** item 0 safety sitting → 0b keep-originals → card split (2b) → modes → checklist/table → frame · + the visibility BOARD half (§4i; the flip RIDES item 0 — ruled 2026-09-06, migration proven). Goal: bits+boards solid for a launchable v1.
...
**Window ownership CLARIFIED (owner, 2026-09-06):** ALL board+bit work — the visibility BOARD half included — lives in THIS window only. The thinking-threads window continues accounts / sharing / sending and does not touch board/bit work.
