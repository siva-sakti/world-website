...
⚑ **What still needs saying honestly:** stage ②'s acceptance must distinguish **what is test-proven** (the logic) from **what is owner-feel-tested** (the gestures). No promising tests that cannot exist.
